                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900"> <strong>What I Know</strong></h1>
                                    <h2 class="h4 text-gray-900">Welcome Back!</h2>
                                </div>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?= base_url('auth/page_regis'); ?>">Create an Account!</a>
                                </div>
                            </div>
                        </div>
                    </div>
